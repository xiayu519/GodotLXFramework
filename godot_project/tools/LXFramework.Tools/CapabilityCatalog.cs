...
internal static class CapabilityCatalog
{
    ...
    public static CapabilityCatalogDocument Build(string root)
    {
        var capabilities = new[]
        {
            new CapabilityDescriptor(
                ...
                [
                    ...
                    Command("check", "lx check <changed-path> [...]", CapabilityCommandKind.ProjectMutation,
                        ["may-update-generated-code", "runs-path-selected-gates", "runs-affected-product-smokes"],
                        ["changed-paths-provided"], "changed-paths-pass"),
                    Command("check", "lx check --plan <changed-path> [...]", CapabilityCommandKind.ReadOnly,
                        [], ["changed-paths-provided"], "check-plan-reported"),
            ...
            new CapabilityDescriptor(
                ...
                [
                    ...
                    Command("smoke", "lx smoke product [id|all|affected <changed-path> ...]", CapabilityCommandKind.ProjectMutation,
                    ...
                    Command("runtime", "lx runtime sample performance [budgets]", CapabilityCommandKind.LocalArtifact,
                        ["writes-.lx-runtime-performance-report"], ["debug-runtime-live"], "runtime-performance-sampled"),
                ],
        ...
        var recipes = new[]
        {
            ...
            Recipe("check-plan-reported", ["command-success", "selected-stages-reported", "no-toolchain-probe-or-execution"]),
            ...
            Recipe("runtime-performance-sampled", ["response-success", "session-generation-current", "sample-window-complete", "declared-budgets-pass"]),
            ...
            Recipe("benchmark-gates-pass", ["command-success", "allocation-gates-pass", "throughput-gates-pass"]),
